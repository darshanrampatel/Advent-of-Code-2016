...
namespace AdventOfCode2016
{
    public sealed partial class MainPage : Page
    {
        ...
        public class Day3
        {
            static string input = @"330  143  338
  769  547   83
  930  625  317
  669  866  147
   15  881  210
  ...
  356  902  922";
            ...
            private bool IsValidTriangle(string triangle)
            {
                var sides = triangle.Split(new[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
                return sides.Length == 3 && Int32.Parse(sides[0]) + Int32.Parse(sides[1]) > Int32.Parse(sides[2]) && Int32.Parse(sides[0]) + Int32.Parse(sides[2]) > Int32.Parse(sides[1]) && Int32.Parse(sides[1]) + Int32.Parse(sides[2]) > Int32.Parse(sides[0]);
            }
        }
    }
}
